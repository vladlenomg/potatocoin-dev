...
This mechanism has been integrated into Bitcore-Node-Potato which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/potatocoin/insight-api-potato#web-socket-api](https://github.com/potatocoin/insight-api-potato#web-socket-api) 
* API: [https://github.com/potatocoin/insight-api-potato#instantsend-transactions](https://github.com/potatocoin/insight-api-potato#instantsend-transactions) 
...
By default, the Potato Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Potato Core daemon:
