...
Only requiring some minor changes is potato.cpp.
...
Changes to potato.cpp
----------------------
potato.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
