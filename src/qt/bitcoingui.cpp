    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Potato Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Potato address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and potato: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Potato Core"), this);
    aboutAction->setStatusTip(tr("Show information about Potato Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Potato Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Potato addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Potato addresses"));
    ...
    openAction->setStatusTip(tr("Open a potato: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Potato Core help message to get a list with possible Potato Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Potato Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Potato network", "", count));
}
...
{
    QString strTitle = tr("Potato Core"); // default title
