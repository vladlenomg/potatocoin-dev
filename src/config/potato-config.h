/* src/config/potato-config.h.  Generated from potato-config.h.in by configure.  */
/* src/config/potato-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/potatocoin/potato/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Potato Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Potato Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "potatocore"
