...
{
    if(fLiteMode) return; // ignore all Potato related functionality
...
/*
    ...
    allow endless transaction that would bloat Potato and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("potato-privatesend");
