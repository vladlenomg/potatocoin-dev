...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PotatoNetwork") type = PotatoNetwork;
    if(strType == "PotatoNetworkVariable") type = PotatoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PotatoNetwork) s = "PotatoNetwork";
    if(type == PotatoNetworkVariable) s = "PotatoNetworkVariable";
